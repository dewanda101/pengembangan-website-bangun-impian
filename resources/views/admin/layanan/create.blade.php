                ...
                <div class="card p-4" style="max-width: 700px;">
                    <form action="{{ route('admin.layanan.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="icon_color" class="form-control @error('icon_color') is-invalid @enderror" placeholder="Contoh: #2a5f7f atau var(--primary)" value="{{ old('icon_color', 'var(--primary)') }}">
