                ...
                <div class="card p-4" style="max-width: 700px;">
                    <form action="{{ route('admin.layanan.update', $layanan) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="fitur_1" class="form-control @error('fitur_1') is-invalid @enderror" value="{{ old('fitur_1', $layanan->fitur_1) }}" required>
                            @error('fitur_1') <span class="invalid-feedback">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Fitur 2 *</label>
                            <input type="text" name="fitur_2" class="form-control @error('fitur_2') is-invalid @enderror" value="{{ old('fitur_2', $layanan->fitur_2) }}" required>
                            @error('fitur_2') <span class="invalid-feedback">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Fitur 3 *</label>
                            <input type="text" name="fitur_3" class="form-control @error('fitur_3') is-invalid @enderror" value="{{ old('fitur_3', $layanan->fitur_3) }}" required>
