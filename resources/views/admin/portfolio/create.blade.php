                ...
                <div class="card p-4" style="max-width: 700px;">
                    <form action="{{ route('admin.portfolio.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="luas" placeholder="Contoh: 250 m²" class="form-control @error('luas') is-invalid @enderror" value="{{ old('luas') }}" required>
                            @error('luas') <span class="invalid-feedback">{{ $message }}</span> @enderror
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Tahun *</label>
                            <input type="text" name="tahun" placeholder="Contoh: 2023" class="form-control @error('tahun') is-invalid @enderror" value="{{ old('tahun') }}" required>
